...
$('#chart1').highcharts({
    ...
    title: { <c:set var="length" value="${fn:length(dates)}"/>
        text: 'Activity statistics from ${dates[0]} to ${dates[length-1]}',
        align: 'left',
        x: 40
    },

    subtitle: {
        text: 'Activity variation by day and hour through 2013',
        align: 'left',
        x: 40
    },
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-bed"></i> Activity monitoring
                            </li>
                        </ol>
                    </div>
                </div>
		...
		<div class="row">
                    ...
                    <div class="col-lg-9 ${hide}">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Activity Graph</h3>
                            </div>
                            <div class="panel-body">
